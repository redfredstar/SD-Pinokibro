...
class TestP02ProcessManager(unittest.TestCase):
    ...
    def test_shell_run_simple_command(self):
        ...
        pid = self.process_manager.shell_run("echo 'Hello, World!'", self.mock_callback)
    ...
    def test_shell_run_with_stderr(self):
        ...
        pid = self.process_manager.shell_run(
            "bash -c 'echo \"Error message\" >&2'", self.mock_callback
        )
    ...
    def test_get_active_processes(self):
        ...
        # Start a process
        pid1 = self.process_manager.shell_run("sleep 1", self.mock_callback)
    ...
    def test_kill_process(self):
        ...
        pid = self.process_manager.shell_run("sleep 10", self.mock_callback)
    ...
    def test_shell_run_with_working_directory(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            pid = self.process_manager.shell_run("ls", self.mock_callback, cwd=temp_dir)
    ...
    def test_kill_process_permission_error(self, mock_kill):
        ...
        # Start a process
        pid = self.process_manager.shell_run("sleep 1", self.mock_callback)
    ...
    def test_concurrent_process_execution(self):
        ...
        for i in range(3):
            pid = self.process_manager.shell_run(
                f"echo 'Process {i}'", self.mock_callback
            )
            pids.append(pid)
