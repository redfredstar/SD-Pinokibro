...
spec = importlib.util.spec_from_file_location("P05_SearchEngine", os.path.join(os.path.dirname(os.path.dirname(__file__)), "Core", "P05_SearchEngine.py"))
...
class TestP05SearchEngine(unittest.TestCase):
    ...
    def test_create_app_from_data_missing_required_field(self):
        ...
        invalid_data = {"id": "test", "name": "Test App"}  # Missing description and category
    ...
    def test_calculate_relevance_score(self):
        ...
        score1 = self.search_engine._calculate_relevance_score(app, "python image editor")
